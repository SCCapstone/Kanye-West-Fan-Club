...
public class PopularBuild2Info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<PopularBuild2> popularBuild2s = type.getPopularBuilds();
        ...
        renderPopularBuilds(popularBuildContainer, popularBuild2s);
    ...
    private void renderPopularBuilds(ScrollView popularBuildContainer, List<PopularBuild2> popularBuild2List) {
        ...
        new Thread(() -> {
            ...
            for (int i = 0; i < popularBuild2List.size(); i++) {
                createPopularBuildCard(i, popularBuild2List.get(i));
            }
        }).start();
    }

    private void createPopularBuildCard(int cardPosition, PopularBuild2 popularBuild2) {
        LinearLayout linearLayout = popularBuildContainer.findViewById(R.id.west_container_linear_layout);
        String buildName = popularBuild2.getBuildName();
        String unit1 = popularBuild2.getUnit1();
        String unit2 = popularBuild2.getUnit2();
        String unit3 = popularBuild2.getUnit3();
        String unit4 = popularBuild2.getUnit4();
        String unit5 = popularBuild2.getUnit5();
        String unit6 = popularBuild2.getUnit6();
        String unit7 = popularBuild2.getUnit7();
        String unit8 = popularBuild2.getUnit8();
    ...
    public void ClickBack(View view) {
        MainActivity.redirectActivity(this, PopularBuilds2.class);
    }
